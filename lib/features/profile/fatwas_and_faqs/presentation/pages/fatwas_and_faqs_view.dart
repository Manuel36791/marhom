                      ...
                      fatwasSuccess: (state) {
                        return Flexible(
                          ...
                          child: ListView.builder(
                            itemCount: state.qaData!.length,
                            itemBuilder: (context, index) {
                              return Padding(
                                padding: const EdgeInsets.all(Dimensions.p8),
                                child: ExpandableQuestionTile(
                                  question: Intl.getCurrentLocale() == "en"
                                      ? state.qaData![index].questionEn!
                                      : state.qaData![index].questionAr!,
                                  answer: Intl.getCurrentLocale() == "en"
                                      ? state.qaData![index].answerEn!
                                      : state.qaData![index].answerAr!,
                                ),
                              );
                            },
                          ),
